...
export default function DyesStocktakeListPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    try {
      ...
      if (data?.id) {
        router.push(`/toolbox/dyes/stocktake/${data.id}`);
      }
    } catch (err: any) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-slate-900">
            Dyes &amp; Chemicals Stocktakes
          </h1>
          <p className="mt-1 text-slate-600">
            Manage formal month-end stocktake sessions for dyes &amp;
            chemicals.
          </p>
        </div>
        <Link
          ...
          >
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <input
                ...
                placeholder="e.g. Jan 2026 Stocktake"
                required
              />
            </div>
            <div>
      ...
      >
        ...
        {isLoading ? (
          ...
          <p className="text-sm text-slate-600">
            No stocktake sessions recorded yet.
          </p>
        ) : (
                ...
                {sessions.map((s) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <button
                        onClick={() =>
                          router.push(`/toolbox/dyes/stocktake/${s.id}`)
                        }
